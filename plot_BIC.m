function [] = plot_BIC()
    ...
    loglik_MC1 	= load('./MC1_fixed_transcription/mlvalues.mat');
    loglik_MC2 	= load('./MC2_fixed_cyp2c9_transcription/mlvalues.mat');
    loglik_MC3 	= load('./MC3_varying_transcription/mlvalues.mat');
